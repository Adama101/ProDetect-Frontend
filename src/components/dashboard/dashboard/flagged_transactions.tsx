...
const iconMapping = { Web: DesktopIcon, iPad: DeviceTabletIcon, Mobile: PhoneIcon } as Record<string, Icon>;
...
export function FlaggedTransactions({ chartSeries, labels, sx }: FlaggedTransactionsProps): React.JSX.Element {
